...
function Datepicker() {
	...
	this.regional[ "" ] = { // Default regional settings
		...
		monthNamesShort: [ "Sty", "Lut", "Mar", "Kw", "Maj", "Czer", "Lip", "Sier", "Wrz", "Paź", "Lis", "Gru" ], // For formatting
		dayNames: [ "Niedziela", "Poniedziałek", "Wtorek", "środa", "Czwartek", "Piątek", "Sobota" ], // For formatting
		dayNamesShort: [ "Ndz", "Pon", "Wt", "Śr", "Cw", "Piąt", "Sob" ], // For formatting
		dayNamesMin: [ "Nd","Po","Wt","Śr","Cz","Pt","So" ], // Column headings for days starting at Sunday
